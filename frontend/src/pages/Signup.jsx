...
const Signup = () => {
    ...
    // Removed auto-redirect to avoid race conditions with backend API
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errorMessage = err.response?.data?.message || t('Failed to create account');
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">{t('Start your journey to finding the perfect career path')}</p>
                </div>
